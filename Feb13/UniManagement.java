...
abstract class Person{ //class person
    private int age;
...
class Student extends Person{ //inherited class student
...
class Teacher extends Person{ //inherited class teacher
    Scanner sc=new Scanner(System.in);
    int tNo;
...
class course // class created for the details of courses
{
...
class University{ //class university
    ...
    void addStudent() //to add student in list of students
    {
    ...
    void addTeacher() //to add teacher
    {
    ...
    void AddCourseToStudent() //add course to list of courses
    {
    ...
    void DisplayAllCourses()// display courses
    {
    ...
    void TeacherDisplayDetails() //display teacher details
    {
        int ind=findTeacher(teachers, SetOfTNo);
        if(ind!=-1)
        {
    ...
    void removeCourse() //to remove course
    {
        int ind=findStudent(students, SetOfRollNo);
        if(ind!=-1)
        {
    ...
    void DisplayAllStudents() //display student list
    {
